...
public class allCoursesController implements Initializable {
    @FXML
    public TreeTableColumn Col_Course;
    @FXML
    ...
    public void applyFilter(ActionEvent actionEvent, int filterType)
    {
            switch(filterType) 
            {
                case 1:
                    allCourses.loadTree(Database.getInstance().getActiveCourses());
                    break;
                case 2:
                    allCourses.loadTree(Database.getInstance().getInactiveCourses());
                    break;
            }
    }
}
